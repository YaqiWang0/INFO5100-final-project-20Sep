...
public class CustomerLogPage extends JFrame {
    ...
    private String carId = VehicleDetails.vehicleID();
    /**
    ...
    public CustomerLogPage() {
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // check
                try {
                    boolean response = new NotiDaoImpl().isFindCustomer(userNameTextField.getText(), passwordField.getText());
                    if(response){
                        dispose();
                        customer = new Customer(userNameTextField.getText(), null, null);
                        new UserHome(customer);
                        carData.insertVehicle(carId, "Unknown", customer);;
                    }else{
                        new mistake();
                    }
